...
from module.map.assets import MAP_PREPARATION, MAP_PREPARATION_OLD
...
class Camera(MapOperation):
    ...
    def _update_view(self):
        ...
        try:
            ...
            elif self.appear(MAP_PREPARATION, offset=(20, 20)) or self.appear(MAP_PREPARATION_OLD, offset=(20, 20)):
